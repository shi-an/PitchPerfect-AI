  ...
  if (!report) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-slate-300">
        ...
        <h2 className="text-2xl font-bold text-white">Generating Term Sheet</h2>
        <p className="text-slate-500 mt-2">Gemini 2.5 is analyzing your performance...</p>
      </div>
    );
  }
    ...
    <div className="max-w-5xl mx-auto p-6 md:p-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
      ...
      <div className={`p-8 md:p-12 rounded-3xl mb-12 text-center border-2 shadow-2xl relative overflow-hidden ${isFunded ? 'bg-emerald-950/30 border-emerald-500/50' : 'bg-red-950/30 border-red-500/50'}`}>
        ...
        <div className="relative z-10">
            ...
            {report.funding_decision.toUpperCase()}
            </h2>
            
            <div className="inline-flex items-center gap-3 bg-slate-900/50 px-6 py-2 rounded-full border border-slate-700">
                <span className="text-slate-400 text-sm font-medium uppercase tracking-wider">Final Interest Score</span>
      ...
      <div className="grid md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-8 space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                 <div className="bg-slate-900/50 p-6 rounded-2xl border border-slate-800">
                    ...
                    <CheckCircle className="w-4 h-4" /> Winning Points
                    </h3>
        ...
        <div className="md:col-span-4 space-y-4">
             <div className="bg-slate-800 p-6 rounded-3xl border border-slate-700 text-center">
                <h4 className="text-white font-bold mb-2">Ready to try again?</h4>
                <p className="text-slate-400 text-sm mb-6">Apply these learnings to your next simulation.</p>
                <button 
                    onClick={onRestart}
             ...
             <div className="bg-slate-900 p-6 rounded-3xl border border-slate-800">
                <h4 className="text-slate-500 text-xs font-bold uppercase tracking-wider mb-4">Pitch Stats</h4>
